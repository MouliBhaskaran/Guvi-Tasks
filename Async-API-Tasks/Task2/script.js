// Promise Task - 2 -THIRUKKURAL API 
...
heading.innerHTML = "திருக்குறள் API by Mouli Bhaskaran";
const desc = document.createElement("div");
desc.innerHTML =
  "Get immersed in the world of Thirukkural";
...
async function tkrl() {
  ...
  if (input < 1 || input > 1330) {
    ...
    let data1 = await fetch(
      `https://api-thirukkural.vercel.app/api?num=${input}`
    );
    ...
    <img src="./thiru.jpg" class="card-img-top" alt="image">
    <div class="card-body">
